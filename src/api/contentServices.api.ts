...
export const blogService = {
  ...
  getById: async (id: string): Promise<ApiResponse<BlogPost>> => {
    return authFetch(API_ENDPOINTS.BLOG.GET_BY_ID(id));
  },

  // Create new blog post
  create: async (data: BlogPostFormData): Promise<ApiResponse<BlogPost>> => {
    return authFetch(API_ENDPOINTS.BLOG.CREATE, {
      method: 'POST',
  ...
  update: async (id: string, data: Partial<BlogPostFormData>): Promise<ApiResponse<BlogPost>> => {
    return authFetch(API_ENDPOINTS.BLOG.UPDATE(id), {
      method: 'PUT',
      body: JSON.stringify(data),
    });
  },
  ...
  delete: async (id: string): Promise<ApiResponse<void>> => {
    return authFetch(API_ENDPOINTS.BLOG.DELETE(id), {
      method: 'DELETE',
    });
  },
  ...
  getStats: async (): Promise<ApiResponse<any>> => {
    return authFetch(API_ENDPOINTS.BLOG.GET_STATS);
  },
};
...
export const mediaService = {
  ...
  getById: async (id: string): Promise<ApiResponse<MediaLibrary>> => {
    return authFetch(API_ENDPOINTS.MEDIA.GET_BY_ID(id));
  },

  // Get media by category
  getByCategory: async (category: string): Promise<ApiResponse<MediaLibrary[]>> => {
    return authFetch(API_ENDPOINTS.MEDIA.GET_BY_CATEGORY(category));
  },
  ...
  uploadMultiple: async (files: File[], category?: string, folder?: string): Promise<ApiResponse<MediaLibrary[]>> => {
    ...
    const response = await fetch(API_ENDPOINTS.MEDIA.UPLOAD_MULTIPLE, {
      method: 'POST',
      headers: {
        ...(token && { Authorization: `Bearer ${token}` }),
      },
  ...
  update: async (id: string, data: Partial<MediaLibrary>): Promise<ApiResponse<MediaLibrary>> => {
    return authFetch(API_ENDPOINTS.MEDIA.UPDATE(id), {
      method: 'PUT',
      body: JSON.stringify(data),
    });
  },
  ...
  // Delete media
  delete: async (id: string): Promise<ApiResponse<void>> => {
    return authFetch(API_ENDPOINTS.MEDIA.DELETE(id), {
      method: 'DELETE',
    });
  },
  ...
  getStats: async (): Promise<ApiResponse<any>> => {
    return authFetch(API_ENDPOINTS.MEDIA.GET_STATS);
  },
};
