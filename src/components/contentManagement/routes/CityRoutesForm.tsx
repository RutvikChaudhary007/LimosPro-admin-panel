...
export default function CityRoutesForm({
  ...
  const routesArray = useFieldArray({
                        ...
                        <CardContent className="p-4 space-y-3">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                            <Field>
                              ...
                              <InputGroup>
                                <InputGroupInput
                                  {...form.register(`routes.${index}.fromCity`)}
                                />
                              </InputGroup>
                            </Field>
                            <Field>
                              ...
                              <InputGroup>
                                <InputGroupInput
                                  {...form.register(`routes.${index}.toCity`)}
                                />
                              </InputGroup>
                            </Field>
                            <Field>
                              ...
                              <InputGroup>
                                <InputGroupInput
                                  {...form.register(`routes.${index}.fromSlug`)}
                                />
                              </InputGroup>
                            </Field>
                            <Field>
                              ...
                              <InputGroup>
                                <InputGroupInput
                                  {...form.register(`routes.${index}.toSlug`)}
                                />
                              </InputGroup>
                            </Field>
                            <Field>
                              ...
                              <InputGroup>
                                <InputGroupInput
                                  {...form.register(`routes.${index}.country`)}
                                />
                              </InputGroup>
                            </Field>
                            <Field>
                            ...
                            <Field>
                              ...
                              <InputGroup>
                                <InputGroupInput
                                  {...form.register(`routes.${index}.time`)}
                                />
                              </InputGroup>
                            </Field>
                            <Field>
                              ...
                              <InputGroup>
                                <InputGroupInput
                                  {...form.register(`routes.${index}.distance`)}
                                />
                              </InputGroup>
                            </Field>
                          </div>
