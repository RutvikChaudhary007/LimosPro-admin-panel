...
const ReplyFC = ({isModal,setIsModal}:{isModal: boolean, setIsModal: React.Dispatch<React.SetStateAction<boolean>>})=>{
  
  return (<Dialog open={isModal} onOpenChange={setIsModal}>
          ...
          <DialogContent className="overflow-y-scroll min-w-[680px] max-h-screen px-5">
            ...
            <hr className="w-full h-[1px] bg-[#EEEEEE]" />
                ...
                <div className="h-[217px] w-[600px] mt-10">
                  ...
                  <Textarea className="h-full rounded placeholder:text-[#E6E6E6] font-medium" placeholder="Write Subject here" />
                </div>
          </DialogContent>
        </Dialog>)
}
