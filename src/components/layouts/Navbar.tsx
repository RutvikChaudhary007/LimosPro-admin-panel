			...
			<div className="w-full h-full flex justify-between">
				<div className="flex 1xl:w-[443px] 1xl:h-[43px] items-center gap-6">
					...
					<div className=" 1xl:h-full flex items-center gap-[6px]">
						...
						<div className="font-['Akatab'] 1xl:w-[50px] 1xl:h-[22px]">
							English
						</div>
					</div>
					<div className="1xl:w-[295px] h-full px-1.5 1xl:py-3 flex items-center bg-[#F8F8F8] shadow-inner shadow-[#F3F3F3] rounded-[6px]">
						...
						/>
						<Input
							className="font-['Akatab'] text-sm bg-transparent shadow-none focus:border-0 focus-visible:ring-0 focus:shadow-none focus:outline-0 border-0 outline-0 placeholder:text-[#D4D4D4]"
							placeholder="Search for booking, fleets, Chauffeurs"
						/>
					</div>
				</div>
					...
					<div className="w-[123px]">
						<DropdownMenu>
							<DropdownMenuTrigger asChild>
								<button
									className="flex gap-3 cursor-pointer hover:outline-none"
									onClick={() => {
										setIsOpen(!isOpen);
										console.log("clicked");
									}}
								>
									...
									<div className="flex items-center justify-center">
										...
										<ChevronDown
											className={cn(
												"w-3.5 h-3.5 text-black transition-transform duration-600 p-[3px]",
												isOpen && "rotate-180",
											)}
										/>
									</div>
