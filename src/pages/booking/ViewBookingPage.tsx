        ...
        <Header className="p-4 h-[79px] bg-[#FDFDFD] shadow-base-light mt-4 mb-5">
          <div className="w-full h-full flex items-center justify-between">
            <div>
              ...
              <h4>
                {" "}
                <span className="text-[#959595] w-[116px] h-4 text-xs">Bookings</span>{" "}
                <span className="text-xs text-[#3A3A3A] w-[50px] h-4">/ View</span>
              </h4>
            </div>
          </div>
        </Header>
        {isFetching ? (
          ...
          <Card className="inset-shadow-xs inset-shadow-[#F1F1F1] bg-[#FDFDFD] rounded-[6px] px-5 space-y-6">
            <CardHeader className="w-full h-[55px] flex items-center justify-between">
              ...
              <Button
                variant="outline"
                className={`w-[180px] h-[39px] flex items-center justify-between rounded mt-5 shadow-inner shadow-[#F1F1F1] cursor-pointer bg-[#FFFFFF] ${getStatusColor("Payment Done")} ${"text-black"}`}
              >
                Payment Done
              </Button>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="w-full space-y-4">
                ...
                <div className="flex items-center gap-6">
                  ...
                  <span className="text-[#3A3A3A] font-medium underline">
              ...
              <div className="w-full space-y-4">
                ...
                <div className="w-full h-[22px] flex items-center gap-6">
                  <Label className="text-sm font-semibold capitalize w-[80px]">Status:</Label>
                  <span className="text-white font-medium bg-[#3A3A3A] px-3.5 py-1 rounded text-xs ">
                    {data?.status}
                  </span>
                </div>

                <div className="w-full h-[22px] flex items-center gap-6">
                  <Label className="text-sm font-semibold capitalize w-[80px]">Type:</Label>
                  <span className="text-[#3A3A3A] font-medium capitalize">{data?.bookingType}</span>
                </div>

                <div className="w-full h-[22px] flex items-center gap-6">
                  <Label className="text-sm font-semibold capitalize w-[80px]">From:</Label>
                  <span className="text-[#3A3A3A] font-medium">{Locations?.pickUpAddress}</span>
                </div>

                <div className="w-full h-[22px] flex items-center gap-6">
                  <Label className="text-sm font-semibold capitalize w-[80px]">To:</Label>
                  <span className="text-[#3A3A3A] font-medium">{Locations?.dropOffAddress}</span>
                </div>

                <div className="w-full h-[22px] flex items-center gap-6">
                  <Label className="text-sm font-semibold capitalize w-[80px]">Price:</Label>
