...
import { useFetchAllServicePricings } from "@/api";
...
function ServicePricingPage() {
  ...
  const { data, refetch, isPending, isError } = useFetchAllServicePricings({
  ...
  const columns = getServicePricing(handleEdit, handleDelete);
  ...
  return (
    <>
      <PageTitle title={generatePageTitle("Service Pricing")} />
      <div className="p-6 space-y-6 md:p-8 md:space-y-8">
        <PageHeader
          ...
          action={{
            ...
            icon: <Plus />,
            link: constant.ROUTING_URLS.CREATE_SERVICE_PRICING,
