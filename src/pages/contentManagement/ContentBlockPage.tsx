...
//   const bulkDeleteChauffeurMutation = queries.useBulkDeleteChauffeurMutation();
  ...
  const { currentPage,  setPage, totalPages, currentItems } = usePagination<any>(data?.chauffeurs || [], newPage, perPage, data?.pagination);
      ...
      <div className="px-10 py-6 h-[calc(100vh-146px)] overflow-y-scroll">
        <Header className="p-4 h-[79px] bg-[#FDFDFD] shadow-[0_4px_20px_rgba(0,0,0,0.05)]">
          <div className="w-full h-full flex items-center justify-between">
            <div>
              ...
              <h4> <span className="text-[#515151] w-[116px] h-4 text-xs">LIMOSPRO</span> <span className="text-xs text-[#939393] w-[50px] h-4">/ Content Block</span></h4>
            </div>
        ...
        <div className="flex justify-between gap-2.5">
          ...
          <div className="w-[369px] h-[39px] mt-5 flex items-center justify-end gap-3">
            ...
            <BulkDeleteBtn rowSelection={rowSelection} tableRef={tableRef} bulkDeleteMutation={()=>{}} refetch={refetch} setRowSelection={setRowSelection} title="Chauffeurs" descTitle="chauffeur"/>
            </span>
