        ...
        <div className="px-10 py-6 h-[calc(100vh-146px)] overflow-auto">
          ...
          <div className="flex justify-between">
            ...
            <div className="w-[369px] h-[39px] mt-5 flex items-center justify-between gap-3">
              ...
              <BulkDeleteBtn rowSelection={rowSelection} tableRef={tableRef} bulkDeleteMutation={bulkDeleteNews} refetch={refetch} setRowSelection={setRowSelection} title="News" descTitle="news"/>
              </span>
