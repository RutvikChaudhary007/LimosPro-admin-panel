					...
					<div className="w-full h-[54px]">
						<div className="w-full h-full flex items-center justify-start gap-5">
							<img
								...
								src="/header/Group.svg"
								alt="Group.svg"
							/>
							<div className="w-full h-full">
								<h5 className="font-['Akatab'] font-medium text-xl">
									Hello,Robert Hayes
								</h5>
								<h6 className="text-sm text-[#3A3A3A]">
						...
						<div className="flex flex-col gap-2.5 relative">
							...
							<Card className="h-[140px] w-full grid gap-5 md:grid-cols-2 lg:grid-cols-4 pt-1.5 xxl:pr-6">
								{[
									{
										Label: "Total Revenue",
										count: data?.totals?.totalRevenue,
										money: true,
									},
									{
										Label: "Total Bookings",
										count: data?.totals?.totalBookings,
										money: false,
									},
									{
										Label: "Total Affiliates",
										count: data?.totals?.totalAffiliates,
										money: false,
									},
									{
										Label: "Total Chauffeurs",
										count: data?.totals?.totalChauffeurs,
										money: false,
									},
								].map((raw, i) => (
									<div
										key={i}
										className="p-4 w-[250px] h-full rounded bg-linear-to-r from-[#FFFFFF] to-[#EBEBEB]"
									>
										<div className="w-full h-[94px] flex flex-col gap-1.5">
											<div className="w-full h-6 relative flex items-center justify-center">
												<div className="absolute right-0 top-0 h-6 w-[57px] bg-[#5E5E5E] rounded-[20px] text-white flex items-center justify-center gap-0.5 p-1.5">
													...
													<span className="1xl:w-[27px] 1xl:h-4 flex items-center font-semibold text-xs">
														5.1%
													</span>
												</div>
											</div>
									...
									<div className="w-full h-full flex flex-col gap-2.5 relative">
										<div className="w-full h-6 flex justify-between">
											...
											<div className="w-[71px] rounded bg-[#F5F5F5] shadow-inner shadow-[#EEEEEE] py-2 px-1 flex items-center justify-between">
												<div className="w-full h-full text-xs text-[#959595] flex items-center">
													Daily
												</div>
