                ...
                <Header className="p-4 h-[79px] bg-[#FDFDFD] shadow-[0_4px_20px_rgba(0,0,0,0.05)] mt-4 mb-5">
                    <div className="w-full h-full flex items-center justify-between">
                        <div>
                            ...
                            <h4> <span className="text-[#959595] w-[116px] h-4 text-xs">Refund</span> <span className="text-xs text-[#3A3A3A] w-[50px] h-4">/ View Refund</span></h4>
                        </div>
                    </div>
                </Header>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <DropdownMenu >
                                    <DropdownMenuTrigger asChild>
                                        <Button variant="outline" className={`w-[180px] h-[39px] flex items-center justify-between rounded shadow-inner shadow-[#F1F1F1] cursor-pointer bg-[#FFFFFF] ${getNewStatusColor(selectedStatus.label)} ${selectedStatus.label === "Payment Done" && "text-white"}`}>
