					...
					<ErrorBoundary>
						<Routes>
							<Route element={<AuthLayout />}>
								<Route
									path={constant.ROUTING_URLS.ADMIN_LOGIN}
									element={<LoginPage />}
								/>
							</Route>
							{/* Protected wrapper */}
							<Route element={<ProtectedRoute />}>
								<Route element={<Layout />}>
									<Route
										index
										path={constant.ROUTING_URLS.DASHBOARD}
										element={<DashboardPage />}
									/>
									<Route
										path={constant.ROUTING_URLS.REGION}
										element={<RegionDashboardPage />}
									/>
									<Route
										path={constant.ROUTING_URLS.CREATE_REGION}
										element={<AddRegionPage />}
									/>
									<Route
										path={constant.ROUTING_URLS.EDIT_REGION}
										element={<EditRegionPage />}
									/>
									<Route
										path={constant.ROUTING_URLS.REGION_ADMIN}
										element={<RegionAdminPage />}
									/>
									<Route
									...
									/>
									<Route
										path={constant.ROUTING_URLS.AFFILIATE}
									...
									/>
									<Route
										path={constant.ROUTING_URLS.CHAUFFEUR}
										element={<ChauffeurPage />}
									/>
									<Route
									...
									/>
									<Route
										path={constant.ROUTING_URLS.BOOKING}
										element={<BookingPage />}
									/>
									<Route
										path={constant.ROUTING_URLS.VIEW_BOOKING}
										element={<ViewBookingPage />}
									/>
									<Route
										path={constant.ROUTING_URLS.USERS}
										element={<UsersPage />}
									/>
									<Route
										path={constant.ROUTING_URLS.CREATE_USERS}
										element={<CreateUserPage />}
									/>
									<Route
										path={constant.ROUTING_URLS.EDIT_USERS}
										element={<EditUserPage />}
									/>
									<Route
										path={constant.ROUTING_URLS.VIEW_USERS}
										element={<ViewUserPage />}
									/>
									<Route
										path={constant.ROUTING_URLS.FLEETS}
										element={<FleetPage />}
									/>
									<Route
										path={constant.ROUTING_URLS.CREATE_FLEET}
										element={<CreateFleetPage />}
									/>
									<Route
										path={constant.ROUTING_URLS.EDIT_FLEET}
										element={<EditFleetPage />}
									/>
									<Route
										path={constant.ROUTING_URLS.VIEW_FLEET}
										element={<ViewFleetPage />}
									/>
									<Route
										path={constant.ROUTING_URLS.CREATE_FLEET}
										element={<CreateFleetPage />}
									/>
									<Route
										path={constant.ROUTING_URLS.TRIPS}
										element={<TripsPage />}
									/>
									<Route
										path={constant.ROUTING_URLS.TRIPS_MAP}
										element={<TripMapPage />}
									/>
									<Route
										path={constant.ROUTING_URLS.VIEW_TRIPS}
										element={<ViewTripsPage />}
									/>
									{/* <Route path={constant.ROUTING_URLS.NOTIFICATION} element={<NotificationPage />} /> */}
									<Route
										path={constant.ROUTING_URLS.PAYMENTS}
										element={<PaymentsPage />}
									/>
									<Route
										path={constant.ROUTING_URLS.VIEW_PAYMENTS}
										element={<ViewPaymentPage />}
									/>
									<Route
										path={constant.ROUTING_URLS.REFUND}
										element={<RefundPage />}
									/>
									<Route
										path={constant.ROUTING_URLS.VIEW_REFUND}
										element={<ViewRefundPage />}
									/>
									<Route
									...
									/>
									<Route
										path={constant.ROUTING_URLS.CREW_MEMBERS}
										element={<CrewMemberPage />}
									/>
									<Route
									...
									/>
									<Route
										path={constant.ROUTING_URLS.TESTIMONIALS}
									...
									/>
									<Route
										path={constant.ROUTING_URLS.OUR_PARTNERS}
									...
									/>
									<Route
										path={constant.ROUTING_URLS.NEWS}
										element={<Newspage />}
									/>
									<Route
										path={constant.ROUTING_URLS.CREATE_NEWS}
										element={<CreateNewsPage />}
									/>
									<Route
										path={constant.ROUTING_URLS.EDIT_NEWS}
										element={<EditNewsPage />}
									/>
									<Route
										path={constant.ROUTING_URLS.SETTINGS}
									...
									/>
									<Route
										path={constant.ROUTING_URLS.FAQ}
										element={<FaqsPage />}
									/>
									<Route
										path={constant.ROUTING_URLS.CREATE_FAQ}
										element={<CreateFaqPage />}
									/>
									<Route
										path={constant.ROUTING_URLS.EDIT_FAQ}
										element={<EditFaqPage />}
									/>
									<Route
										path={constant.ROUTING_URLS.REPORTS}
										element={<ReportPage />}
									/>
									...
									/>
									<Route
										path={constant.ROUTING_URLS.EDIT_BLOG_POST}
										element={<EditBlogPostPage />}
									/>
									<Route
										path={constant.ROUTING_URLS.VIEW_BLOG_POST}
										element={<ViewBlogPostPage />}
									/>
									<Route
										path={constant.ROUTING_URLS.SEO}
										element={<SeoPage />}
									/>
